                    ...
                    <View style={{ gap: 10, marginTop: 20 }}>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <Text style={styles.infoText}>
                                {user && user.user_metadata && user.user_metadata.bio ? user.user_metadata.bio : 'No bio added yet'}
                            </Text>
                        </View>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <Text style={styles.infoText}>
                                {user && user.user_metadata && user.user_metadata.phone_number ? user.user_metadata.phone_number : 'No phone number'}
                            </Text>
                        </View>

                        {/* Address */}
                        <View style={styles.infoRow}>
                            <Feather name="map-pin" size={20} color={theme.colors.textLight} />
                            <Text style={styles.infoText}>
                                {user && user.user_metadata && user.user_metadata.address ? user.user_metadata.address : 'No address added'}
                            </Text>
                        </View>
